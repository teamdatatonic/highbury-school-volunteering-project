...
from student_file import task3a_collision_detection
...
def run_robot(robot):
    ...
    while robot.step(timestep) != -1:
        ...
        left_speed, right_speed = task3a_collision_detection(left_distance_sensor_val, right_distance_sensor_val)
